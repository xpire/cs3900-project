...
symbol, exchange, trading_hours, day_lo, day_hi, rise_at_pivot=True
-> day_lo, day_hi, rise_at_pivot required
"""
...
# TODO generate simulated stock objects from the above data
# need access to db, crud.stock, exchange_info
