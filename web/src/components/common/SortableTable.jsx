...
const rows = [
  ...
  createData("T", "Frozen yoghurt", 159, 6.0, 24, 4.0, 6),
  createData("FB", "Gingerbread", 356, 16.0, 49, 3.9, 6),
  createData("CSCO", "Honeycomb", 408, 3.2, 87, 6.5, 6),
  createData("VOD", "Ice cream sandwich", 237, 9.0, 37, 4.3, 6),
  createData("STJ", "Jelly Bean", 375, 0.0, 94, 0.0, 6),
  createData("MDC", "KitKat", 518, 26.0, 65, 7.0, 6),
  //   createData("ABCDEF", "Lollipop", 392, 0.2, 98, 0.0, 6),
  //   createData("ABCDEF", "Marshmallow", 318, 0, 81, 2.0, 6),
  //   createData("ABCDEF", "Nougat", 360, 19.0, 9, 37.0, 6),
  //   createData("ABCDEF", "Oreo", 437, 18.0, 63, 4.0, 6),
];
              ...
              .map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{row.dailyPercentage}</TableCell>
                    <TableCell padding="checkbox">
                      <IconButton
                        //   color="primary"
                        component={Link}
